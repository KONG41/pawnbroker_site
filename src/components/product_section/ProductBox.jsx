...
const ProductBox = (props) => {
  const{img,title,desc,url,data} = props
  return (
    <div className="h-[auto] bg-white shadow my-10">
        <div className="w-full p-[10px] flex flex-col items-center">
            ...
            <Link to={url} className="px-9 py-3 mb-5 rounded-md w-fit text-white text-sm font-semibold bg-blue-900 hover:cursor-pointer" state={data}>Shop Now</Link>
        </div>
    </div>
  )
}
