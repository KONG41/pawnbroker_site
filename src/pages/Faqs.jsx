...
const Faqs = () => {
  return (
    <div className="w-full">
       ...
       <div className="w-full h-[170px] bg-[#f5f7f9] flex">
            <div className="w-[700px] h-[170px] flex flex-row gap-10 mx-auto mt-[-50px]">
        ...
        <div className="w-[60%] m-auto p-7">
            <div className="w-full flex flex-row justify-between p-7">
                <h1 className="text-[#2C5CC5] font-bold text-xl">Most popular articles</h1>
                <a href="#" className="text-[#2C5CC5]">View all articles</a>
            </div>
            <div className="p-7">
                <div className="flex flex-row w-full border-b-[1px]">
                    <a href="#" className="p-9 w-full odd:border-r-[1px]">
                    ...
                    <a href="#" className="p-9 border-b-1 border-r-1 w-full odd:border-r-[1px]">
