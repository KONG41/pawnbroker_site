...
const Register = () => {
  return (
    <div className="w-full bg-[#f7f7f7]">
      <div className="w-[65%] m-auto pb-44 pt-5">
        <div className='flex flex-row justify-between items-center'>
          ...
          <Link to='/login' className=" text-[#0c4ca3] inline-block ml-3 font-light text-sm">Have an account already? Sign in here.</Link>
        </div>
                ...
                <div className="w-full">
                  ...
                  <span className="w-full text-[#6c757d] text-sm mb-5 flex flex-row items-center">
                    ...
                    <div className="flex justify-between w-full gap-7">
                       <select className="border rounded-[4px] w-fit focus:outline-none py-2 px-1 uppercase">
